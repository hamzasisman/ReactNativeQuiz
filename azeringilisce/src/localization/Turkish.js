export const turkish = {
  app_name: 'Azer İngilisce',

  //drawer
  support_drawer: 'Dəstək Mərkəzi',
  log_out_drawer: 'Çıxış',
  settings: 'Parametrlər',
  permissions: 'İcazələr',
  info_message: 'Məlumat Mesajı',

  quiz: {
    top_title: "Quiz & Test",
    title: "Bütün Testlər",
    description: "Aşağıda paketiniz üçün olan testləri görüb həll edə bilərsiniz.",
    answered_quiz: "Əvvəllər cavablandırılmış testlər #check# işarəsi ilə göstərilir.",
